...
declare module 'fabric' {
  export namespace fabric {
    export interface IObjectInteractive extends Object {
      id: string;
      order: number;
    }
...
// ----------------------------------------------------------
    ...
    export function loadSVGFromString(
      string: string, callback: (results: Object[], options: any) => void,
      reviver?: Function
    ): void;
    ...
    export function loadSVGFromURL(
      url: string, callback: (results: Object[], options: any) => void,
      reviver?: Function
    ): void;
    ...
    export function parseAttributes(
      element: HTMLElement, attributes: string[],
      svgUid?: string
    ): { [key: string]: string };
    ...
    export function parseSVGDocument(
      doc: SVGElement, callback: (results: Object[], options: any) => void,
      reviver?: Function
    ): void;
...
//////////////////////////////////////////////////////////////////////////////
    ...
    interface IUtilArc
    {
       ...
       */
      getBoundsOfArc(
        fx: number, fy: number, rx: number, ry: number, rot: number, large: number, sweep: number,
        tx: number, ty: number
      ): Point[];
      /**
       ...
       */
      getBoundsOfCurve(
        x0: number, y0: number, x1: number, y1: number, x2: number, y2: number, x3: number,
        y3: number
      ): Point[];
    }
